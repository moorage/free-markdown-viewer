...
PATH_HINTS = {
    ...
    "Quick Markdown Viewer/Quick Markdown Viewer/": ["ARCHITECTURE.md", "docs/debug-contracts.md"],
    "Quick Markdown Viewer/Quick Markdown ViewerUITests/": ["docs/harness.md", "docs/debug-contracts.md"],
