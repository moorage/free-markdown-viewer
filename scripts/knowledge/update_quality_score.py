...
def main() -> int:
    lines = [
        ...
        f"- harness app shell: {'present' if exists('Quick Markdown Viewer/Quick Markdown Viewer/Harness') else 'missing'}",
        f"- unit tests: {'present' if exists('Quick Markdown Viewer/Quick Markdown ViewerTests') else 'missing'}",
        f"- UI tests: {'present' if exists('Quick Markdown Viewer/Quick Markdown ViewerUITests') else 'missing'}",
